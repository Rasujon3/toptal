...
$(function () {
  ...
  $("#range_09").ionRangeSlider( {
        grid: !0, min: 0, max: 100, from: 30,hide_min_max: !0, hide_from_to: !0, prefix: "margin ", max_postfix: "+"
    }
    ),
  ...
  'use strict';
      ...
      var chart = new ApexCharts(document.querySelector("#charts_widget"), options);
      chart.render();
	...
	var options = {
      ...
      var options = {
        ...
        var options = {
          series: [{
          name: 'series1',
          data: [ 20,10,35,32,40,31,20,25,30,27,80]
          }],
          chart: {
          height: 90,
          type: 'area',
